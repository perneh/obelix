"""Scenario execution engine with timing, pause and stop controls."""
...
class ScenarioRunner:
    ...
    async def start(self, scenario: Scenario) -> ScenarioRunState:
    ...
    def _require_state(self, scenario_id: str) -> ScenarioRunState:
        ...
        if state is None:
            raise KeyError(f"Unknown scenario run: {scenario_id}")
        return state
